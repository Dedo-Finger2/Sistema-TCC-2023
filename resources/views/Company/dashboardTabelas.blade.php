...
@section('content')
    ...
    <div class="row ">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="fw-bold"><strong>Origens com retorno</strong></h5>
                    <span class="small" style="color: gray;">Origens mais requisitadas com retorno.</span>
                    <div class="table-responsive">
                        <hr>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="fw-bold"><strong>Destinos não registrados ainda</strong></h5>
                    <span class="small" style="color: gray;">Destinos que ainda não estão cadastrados no banco de dados, mas que foram requisitados.</span>
                    <div class="table-responsive">
                        <hr>
                        <table id="tabela1" class="table table-striped nowrap table-responsive-tcc" style="width:100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($destinosNaoCadastrados as $item)
                                    <tr>
                                        <td>{{ $item->nome }}</td>
                                        <td>{{ $item->total_requisicoes }}</td>
                                    </tr>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="fw-bold"><strong>Origens não registradas ainda</strong></h5>
                    <span class="small" style="color: gray;">Origens que ainda não estão cadastrados no banco de dados, mas que foram requisitados.</span>
                    <div class="table-responsive">
                        <hr>
                        <table id="tabela2" class="table table-striped nowrap table-responsive-tcc" style="width:100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($origensNaoCadastradas as $item)
                                    <tr>
                                        <td>{{ $item->nome }}</td>
                                        <td>{{ $item->total_requisicoes }}</td>
                                    </tr>
