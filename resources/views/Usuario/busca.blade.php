...
<style>
    ...
    .card-img {
        position: absolute;
        top: 80px; /* Adicionando espaçamento do topo */
        right: 30px; /* Adicionando espaçamento da direita */
        width: 150px; /* Aumentando a largura */
    ...
    .card-title h1 {
        ...
        color: #14bd60; /* Alterando a cor do texto para cinza escuro */
    }
...
<div class="container">
    <div class="card border-success mb-3">
        <div class="card-title">
            <h1 class="text-center">Busca de rotas</h1>
        </div>
        ...
        <form action="{{ route('search.buscar') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="origemRequisitado" id="origem">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="destinoRequisitado" id="destino">
