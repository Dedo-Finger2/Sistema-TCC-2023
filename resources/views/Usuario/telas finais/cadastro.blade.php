  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-6 bg-dark text-white d-flex flex-column justify-content-start align-items-start" style="height: 100vh;">
            ...
            <div class="col-md-6 bg-light d-flex flex-column align-items-center justify-content-center" style="height: 100vh;">
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-7W3Xu28E1o1RvLw3b8U2RkXoA5b9a6G86j5FqzSN2CCJ5SdUZ0gH9U1F5tLPMfFo" crossorigin="anonymous"></script>
  </body>
</html>
